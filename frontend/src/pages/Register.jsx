...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (regResult.success) {
      ...
      if (loginResult.success) {
        ...
        setErr('Registered successfully! Proceeding to Login.');
        navigate('/login');
      }
    } else {
      setErr(regResult.error);
      setSubmitting(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-dark-bg flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md glassmorphism p-8 rounded-2xl shadow-xl border border-gray-800">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2 text-sm">Elevate your preparation with AI analytics</p>
        </div>
